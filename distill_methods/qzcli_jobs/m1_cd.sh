#!/usr/bin/env bash
# qzcli M1 CD (Progressive Distillation) training: HSSD 420 → Toys4k 105 eval
#
# Setup:
#   - 1 GPU (smoke: H100 80GB to verify memory fits; production: H100 or H200)
#   - 15000 steps with checkpointing every 1000 (CD: num_timesteps=50 (default), single-stage training
