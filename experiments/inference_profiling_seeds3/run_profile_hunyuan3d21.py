#!/usr/bin/env python3
"""Block-level inference time profiling for Hunyuan3D-2.1 (v2 — always save mesh).
...
Usage (from models/hunyuan3d21):
    ...
    ../../experiments/inference_profiling_full/run_profile_hunyuan3d21.py \
...
def main():
    parser = argparse.ArgumentParser(description="Hunyuan3D-2.1 block-level profiling (v2)")
    ...
    print(f"Hunyuan3D-2.1 profiling (v2) | steps={num_inference_steps} "
